#!/bin/ksh
#################################################################################################
# Script      :customer_profile_purchase_cdm_summary_onetime.ksh
# Description :This script is used to trigger the sequence customer_profile_purchase_cdm_summary_onetime job
# Modification:
...
. $SCRIPTS_DIR/load_datastage_params.ksh
   ...
   export JOB_NAME="seq_customer_profile_purchase_cdm_summary_onetime"
   ...
   dsjob -run -param job_run_id="$JOB_RUN_ID" -param rollingyears="2" -wait -warn 0 -jobstatus $DATA_STAGE_PROJECT customer_profile_purchase_cdm_summary_onetime
   ds_ret_code=$?
